...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::work_item_plans::save_plan_schemas,
            ...
            commands::routing::get_ai_routing,
            commands::routing::set_area_provider,
            commands::routing::clear_area_provider,
            ...
            commands::runs::collect_agent_record,
            commands::gates::run_gates,
            commands::gates::plan_gates,
            ...
            commands::vcs_ops::list_solution_branches,
            commands::vcs_ops::solution_git_state,
            commands::vcs_ops::init_solution_repo,
            commands::vcs_ops::commit_solution,
            commands::vcs_ops::auto_commit_solution,
            commands::vcs_ops::push_solution,
            commands::vcs_ops::sync_solution,
            commands::vcs_ops::checkout_changes,
            commands::vcs_ops::open_pull_request,
